 ...
 */
final class Version20250927115551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, balance DOUBLE PRECISION NOT NULL DEFAULT 0, PRIMARY KEY(id))');
